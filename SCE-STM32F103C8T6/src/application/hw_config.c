...
void SystemStartup(void) {
 ...
 GPIO_InitStructure.GPIO_Pin = RST_PIN; GPIO_Init(DBG_PORT, &GPIO_InitStructure);

 GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
 GPIO_InitStructure.GPIO_Pin = DBG_PIN; GPIO_Init(DBG_PORT, &GPIO_InitStructure);

 GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_OD;
 GPIO_InitStructure.GPIO_Pin = DBG_LCD_PIN; GPIO_Init(DBG_LED_PORT, &GPIO_InitStructure);
}
